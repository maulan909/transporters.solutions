                ...
                <form action="/teams/" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name')
                            is-invalid
                        @enderror" id="name" name="name" value="{{ old('name', $team->name) }}" placeholder="John Doe"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('position')
                            is-invalid
                        @enderror" id="position" name="position" value="{{ old('position', $team->position) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('linkedin')
                            is-invalid
                        @enderror" id="linkedin" name="linkedin" placeholder="user1102"
                            value="{{ old('linkedin', $team->linkedin) }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" id="whatsapp" name="whatsapp" placeholder="6285212341234"
                            value="{{ old('whatsapp', $team->whatsapp) }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" id="instagram" name="instagram" placeholder="user1102"
                            value="{{ old('instagram', $team->instagram) }}" autocomplete="off">
