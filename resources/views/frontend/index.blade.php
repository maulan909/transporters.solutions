...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;1,300;1,500;1,600;1,700;1,800&display=swap"
        rel="stylesheet">
...
<body id="home" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="5" class="scrollspy-example" tabindex="0">
                    ...
                    <div class="cta">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-5 mb-3 mb-md-0">
                                <a href="#kontak-kami" class="btn btn-theme fw-bold px-5 fs-4 d-block"
                                    data-aos="fade-right" data-aos-delay="1500">Order Sekarang</a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-5">
                                <a href="#tentang-kami"
                                    class="btn btn-outline-secondary px-5 fs-4 text-light border-2 d-block"
                                    data-aos="fade-left" data-aos-delay="2000">Tentang Kami</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="tentang-kami">
        ...
        <div class="container position-relative">
            <div class="row">
                <div class="col-xl-7">
                    <h1 class="section-title text-white mb-5 fw-bold" data-aos="fade-up" data-aos-offset="400"
                        data-aos-delay="500">Tentang Kami</h1>
                    <p class="text-white fs-4 text-justify" data-aos="fade-down" data-aos-offset="400"
                        data-aos-delay="1000">
        ...
        <div class="container pt-5">
            <div class="row justify-content-center">
                <div class="col-10 col-lg-12">
                    <h1 class="position-relative section-title text-white mb-5 fw-bold" data-aos="fade-down"
                        data-aos-anchor="#layanan" data-aos-delay="300">Layanan</h1>
                </div>
            </div>
            <div class="row justify-content-center justify-content-lg-start">
                <div class="col-10 col-lg-6 item-layanan mb-3" data-aos="flip-down" data-aos-anchor="#layanan"
                    data-aos-delay="600">
                    <div class="card bg-theme rounded-3">
                        <div class="card-body p-4 d-flex justify-content-center overflow-hidden">
                                ...
                                <div class="col-lg-8 d-lg-flex py-2">
                                    <div class="row align-self-stretch">
                                        <div class="col-lg-12 align-self-center">
                                            <h2 class="section-title fw-bold text-center text-lg-start">Transportation
                                                and Distribution</h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row link-cta justify-content-center">
                                <div class="col-lg-12">
                                    <a href="#"
                                        class="btn btn-outline-secondary btn-lg col-12 col-lg-12 text-white border-white border-2 rounded-0">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4 d-flex justify-content-center">
                            ...
                            <div class="row item">
                                ...
                                <div class="col-lg-8 d-lg-flex py-2">
                                    <div class="row align-self-stretch">
                                        <div class="col-lg-12 align-self-center">
                                            <h2 class="section-title fw-bold text-center text-lg-start">Supply Chain,
                                                Warehouse, Aggregator Last Mile Delivery</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row link-cta justify-content-center">
                                <div class="col-lg-12">
                                    <a href="#"
                                        class="btn btn-outline-secondary btn-lg col-12 col-lg-12 text-white border-white border-2 rounded-0">Coming
                                        Soon</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 mb-3" data-aos="zoom-out" data-aos-anchor="#our-team">
                    <div class="card bg-theme border-0 shadow rounded-3">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-10 bio rounded-3 py-4 px-2 bg-theme text-center shadow-sm"
                                    data-aos="fade-up" data-aos-anchor="#our-team" data-aos-delay="300">
                                    <h4 class="text-center fw-bold text-center ff-open-sans" data-aos="fade-up"
                                        data-aos-anchor="#our-team" data-aos-delay="600">Arief Setiawan</h4>
                                    <h4 class="text-center text-center mb-3" data-aos="fade-up"
                                        data-aos-anchor="#our-team" data-aos-delay="900">Founder</h4>
                                    <span class="fs-3">
                                        <a href="https://www.linkedin.com/in/arief-setiawan-7a72596b/" target="_blank"
                                            class="rounded-circle bg-white text-theme pt-2 px-2 pb-1 border border-1 border-white mx-2"
                                            data-aos="fade-in" data-aos-anchor="#our-team" data-aos-delay="1200"><i
                                                class="fab fa-linkedin fa-fw"></i></a>
                                        <a href="https://wa.me/6281296481817?text=halo" target="_blank"
                                            class="rounded-circle bg-white text-theme pt-2 px-2 pb-1 border border-1 border-white"
                                            data-aos="fade-in" data-aos-anchor="#our-team" data-aos-delay="1500"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-10 bio rounded-3 py-4 px-2 bg-theme text-center shadow-sm"
                                    data-aos="fade-up" data-aos-anchor="#our-team" data-aos-delay="300">
                                    <h4 class="text-center fw-bold text-center ff-open-sans" data-aos="fade-up"
                                        data-aos-anchor="#our-team" data-aos-delay="600">Wendra Hedi Sucipto</h4>
                                    <h4 class="text-center text-center mb-3" data-aos="fade-up"
                                        data-aos-anchor="#our-team" data-aos-delay="900">Co-Founder</h4>
                                    <span class="fs-3">
                                        <a href="https://www.linkedin.com/in/wendra-hedi-sucipto-5a0386147/"
                                            target="_blank"
                                            class="rounded-circle bg-white text-theme pt-2 px-2 pb-1 border border-1 border-white mx-2"
                                            data-aos="fade-in" data-aos-anchor="#our-team" data-aos-delay="1200"><i
                                                class="fab fa-linkedin fa-fw"></i></a>
                                        <a href="https://wa.me/6281339314904?text=halo" target="_blank"
                                            class="rounded-circle bg-white text-theme pt-2 px-2 pb-1 border border-1 border-white"
                                            data-aos="fade-in" data-aos-anchor="#our-team" data-aos-delay="1500"><i
                                                class="fab fa-whatsapp fa-fw"></i></a>
                                    </span>
    ...
    <section id="partnership">
        <div class="container-fluid py-5">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 class="section-title text-white fw-bold text-center" data-aos="fade-down"
                        data-aos-anchor-placement="bottom-bottom">Our Partner</h1>
                </div>
            </div>
            <div class="row justify-content-center mt-5">
                <div class="col-6 col-sm-4 col-lg-2 d-flex align-items-center" data-aos="zoom-in"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul>
                        <li class="text-white mb-3">Jl. Kencana Suci No.2 Perum Duta Kencana 1, Kel. Curug Mekar, Kec.
                            Bogor Barat, Kota Bogor, Jawa Barat, Indonesia.</li>
                        <li class="text-white mb-3"><i class="fas fa-phone-alt"></i> <a href="tel:08118303131"
                                class="text-white text-decoration-none">081 1830 3131</a></li>
                    </ul>
                </div>
                <div class="col-md-2 offset-lg-1">
                    ...
                    <ul class="text-white">
                        ...
                        <li><a href="#tentang-kami" class="text-white text-decoration-none d-block py-1 px-2">Tentang
                                Kami</a></li>
                        <li><a href="#layanan" class="text-white text-decoration-none d-block py-1 px-2">Layanan</a>
                        </li>
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="fs-4 text-center">
                        <a href="https://instagram.com/we.transporter_id" target="_blank"
                            class="rounded-circle bg-white text-theme pt-1 px-1 pb-0 border border-1 border-white me-2"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="@we.transporter_id"
                            data-aos-anchor="#kontak-kami" data-aos-delay="1400"><i
                                class="fab fa-fw fa-instagram"></i></a>
                        <a href="https://wa.me/628118303131?text=halo" target="_blank"
                            class="rounded-circle bg-white text-theme pt-1 px-1 pb-0 border border-1 border-white"
                            data-aos-anchor="#kontak-kami" data-aos-delay="1400"><i
                                class="fab fa-whatsapp fa-fw"></i></a>
                    </div>
                </div>
